document.addEventListener('DOMContentLoaded', function () {
  ...
  (function () {
    ...
    function getErrorMessage(rule, param) {
      ...
      return ERROR_MESSAGES[rule] || ERROR_MESSAGES.default;
    }
    ...
    function getOrCreateError(field) {
      ...
      let errorEl = fieldWrapper.querySelector('.form-error-message');
      if (!errorEl) {
    ...
    function validateField(field) {
      ...
      if (errorMessage) {
        ...
        if (value.trim() !== '') field.classList.add('field-success');
  ...
  (function () {
    ...
    function applyAnimationTargets() {
      const selectors = [
        '[data-animate]',
        '.animate',
        '.card',
    ...
    (function () {
      let staggerDelay = 0;
      const STAGGER_PARENTS = ['.features-grid', '.cards-grid', '.services-grid', '.team-grid', '.pricing-grid'];

      STAGGER_PARENTS.forEach(function (parentSelector) {
        document.querySelectorAll(parentSelector).forEach(function (parent) {
          staggerDelay = 0;
          parent.querySelectorAll('.' + OBSERVE_CLASS).forEach(function (child) {
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'f4c42d41-f796-48c0-b571-73ea682ac936',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'f4c42d41-f796-48c0-b571-73ea682ac936';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f4c42d41-f796-48c0-b571-73ea682ac936';
